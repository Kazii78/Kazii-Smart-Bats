...
execute as @a[tag=attacker.kz.sb] at @s unless entity @e[type=bat,distance=..20] run scoreboard players add @s core.kz.sb 1
execute as @a[tag=attacker.kz.sb] at @s if entity @e[type=bat,distance=..20] if score @s core.kz.sb matches ..1199 run scoreboard players set @s core.kz.sb 0
