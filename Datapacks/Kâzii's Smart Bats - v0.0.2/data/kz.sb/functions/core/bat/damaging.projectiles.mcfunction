...
execute as @e[type=bat] at @s facing entity @e[type=arrow,distance=..15,tag=!inGround.kz.sb] feet rotated ~ 0 if block ^ ^ ^-0.25 air if block ^ ^ ^-0.5 air if block ^ ^ ^-0.75 air if block ^ ^ ^-1 air run tp @s ^ ^ ^-0.25
execute as @e[type=bat] at @s facing entity @e[type=arrow,distance=..10,tag=!inGround.kz.sb] feet rotated ~ 0 if block ^ ^ ^-0.25 air if block ^ ^ ^-0.5 air if block ^ ^ ^-0.75 air if block ^ ^ ^-1 air run tp @s ^ ^ ^-0.25
execute as @e[type=bat] at @s facing entity @e[type=arrow,distance=..5,tag=!inGround.kz.sb] feet rotated ~ 0 if block ^ ^ ^-0.25 air if block ^ ^ ^-0.5 air if block ^ ^ ^-0.75 air if block ^ ^ ^-1 air run tp @s ^ ^ ^-0.25
...
execute as @e[type=bat] at @s facing entity @e[type=trident,distance=..15,tag=!inGround.kz.sb] feet rotated ~ 0 if block ^ ^ ^-0.25 air if block ^ ^ ^-0.5 air if block ^ ^ ^-0.75 air if block ^ ^ ^-1 air run tp @s ^ ^ ^-0.25
execute as @e[type=bat] at @s facing entity @e[type=trident,distance=..10,tag=!inGround.kz.sb] feet rotated ~ 0 if block ^ ^ ^-0.25 air if block ^ ^ ^-0.5 air if block ^ ^ ^-0.75 air if block ^ ^ ^-1 air run tp @s ^ ^ ^-0.25
execute as @e[type=bat] at @s facing entity @e[type=trident,distance=..5,tag=!inGround.kz.sb] feet rotated ~ 0 if block ^ ^ ^-0.25 air if block ^ ^ ^-0.5 air if block ^ ^ ^-0.75 air if block ^ ^ ^-1 air run tp @s ^ ^ ^-0.25