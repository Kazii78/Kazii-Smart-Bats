...
execute as @e[type=bat,tag=follower.kz.sb,tag=!rogue.kz.sb,tag=!passive.kz.sb] unless entity @e[type=bat,tag=leading.kz.sb,tag=leader.kz.sb,distance=..12] if predicate kz.sb:20.percent run tag @s add rogue.kz.sb
...
execute as @e[type=bat,tag=follower.kz.sb,tag=!rogue.kz.sb,tag=!passive.kz.sb,tag=!leading.kz.sb,tag=!leader.kz.sb] if predicate kz.sb:1.percent run tag @s add rogue.kz.sb