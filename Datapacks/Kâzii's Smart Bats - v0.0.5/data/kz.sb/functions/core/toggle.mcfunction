...
execute if entity @e[type=bat] run function kz.sb:core/general/fears
...
execute if entity @e[type=bat] run function kz.sb:core/general/food
execute if entity @e[type=bat] run function kz.sb:core/bat/feed
execute if entity @e[type=bat] run function kz.sb:core/bat/protect